...
(cl:defclass <ObjectCoordinates> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (objects
    :reader objects
    :initarg :objects
    :type (cl:vector VLN_planner-msg:ObjectCoordinate)
   :initform (cl:make-array 0 :element-type 'VLN_planner-msg:ObjectCoordinate :initial-element (cl:make-instance 'VLN_planner-msg:ObjectCoordinate))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ObjectCoordinates>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObjectCoordinates)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name VLN_planner-msg:<ObjectCoordinates> is deprecated: use VLN_planner-msg:ObjectCoordinates instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ObjectCoordinates>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'objects)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'VLN_planner-msg:ObjectCoordinate))
