...
(cl:defmethod cl:initialize-instance :after ((m <ObjectDetection>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObjectDetection)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name VLN_planner-msg:<ObjectDetection> is deprecated: use VLN_planner-msg:ObjectDetection instead.")))

(cl:ensure-generic-function 'class_name-val :lambda-list '(m))
(cl:defmethod class_name-val ((m <ObjectDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader VLN_planner-msg:class_name-val is deprecated.  Use VLN_planner-msg:class_name instead.")
  (class_name m))

(cl:ensure-generic-function 'x_center-val :lambda-list '(m))
(cl:defmethod x_center-val ((m <ObjectDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader VLN_planner-msg:x_center-val is deprecated.  Use VLN_planner-msg:x_center instead.")
  (x_center m))

(cl:ensure-generic-function 'y_center-val :lambda-list '(m))
(cl:defmethod y_center-val ((m <ObjectDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader VLN_planner-msg:y_center-val is deprecated.  Use VLN_planner-msg:y_center instead.")
  (y_center m))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <ObjectDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader VLN_planner-msg:width-val is deprecated.  Use VLN_planner-msg:width instead.")
  (width m))

(cl:ensure-generic-function 'height-val :lambda-list '(m))
(cl:defmethod height-val ((m <ObjectDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader VLN_planner-msg:height-val is deprecated.  Use VLN_planner-msg:height instead.")
  (height m))

(cl:ensure-generic-function 'confidence-val :lambda-list '(m))
(cl:defmethod confidence-val ((m <ObjectDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader VLN_planner-msg:confidence-val is deprecated.  Use VLN_planner-msg:confidence instead.")
  (confidence m))
