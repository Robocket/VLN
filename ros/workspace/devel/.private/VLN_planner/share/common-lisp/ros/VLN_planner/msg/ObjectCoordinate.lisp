...
(cl:defmethod cl:initialize-instance :after ((m <ObjectCoordinate>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObjectCoordinate)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name VLN_planner-msg:<ObjectCoordinate> is deprecated: use VLN_planner-msg:ObjectCoordinate instead.")))
...
(cl:defmethod point-val ((m <ObjectCoordinate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader VLN_planner-msg:point-val is deprecated.  Use VLN_planner-msg:point instead.")
  (point m))
