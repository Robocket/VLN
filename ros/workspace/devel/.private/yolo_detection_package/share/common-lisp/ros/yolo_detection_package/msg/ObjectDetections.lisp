...
(cl:defclass <ObjectDetections> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (objects
    :reader objects
    :initarg :objects
    :type (cl:vector yolo_detection_package-msg:ObjectDetection)
   :initform (cl:make-array 0 :element-type 'yolo_detection_package-msg:ObjectDetection :initial-element (cl:make-instance 'yolo_detection_package-msg:ObjectDetection))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ObjectDetections>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObjectDetections)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name yolo_detection_package-msg:<ObjectDetections> is deprecated: use yolo_detection_package-msg:ObjectDetections instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ObjectDetections>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'objects)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'yolo_detection_package-msg:ObjectDetection))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ObjectDetections>)))
  ...
  "yolo_detection_package/ObjectDetections")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ObjectDetections)))
  "Returns string type for a message object of type 'ObjectDetections"
  "yolo_detection_package/ObjectDetections")
